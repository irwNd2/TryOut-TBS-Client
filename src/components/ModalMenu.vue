<template>
  <div
    class="bg-white dark:bg-gray-700 rounded-lg relative w-[230px] my-6 mx-auto flex flex-col justify-start gap-1 p-1 mr-4 shadow-lg ring-1 ring-black ring-opacity-5"
  >
    <div
